            ...
            try {
                ...
                switch (function) {
                    case READ_FILE:
                        ...
                        while (is.read() != -1) {
                            count++;       //qtde de bytes lidos. Não sei se vai precisar, talvez se precisar "debugar"
                        }
                        break;
                    case WRITE_FILE:
                ...
                Logger.getLogger(NodeClientFileSystem.class.getName()).log(Level.SEVERE, null, ex);
            } finally {
                try {
                    is.close();
                } catch (IOException ex) {
